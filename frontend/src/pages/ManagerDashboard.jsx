      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            scrolled
              ? "bg-neugray-bg/70 backdrop-blur-sm shadow-md"
              : "bg-neugray-bg"
          }`}
        >
          <div className="max-w-7xl mx-auto p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-0">
              <div className="flex items-center gap-3">
                <img
                  src={flowe}
                  className="min-w-10 min-h-10 w-12 h-12 max-sm:pt-3 opacity-90"
                  alt="Logo"
                />
                <h1 className="text-xl sm:text-2xl font-bold text-neugray-text">
                  HiringManager Dashboard
                </h1>
              </div>
              <button
                onClick={handleLogout}
        ...
        >
          <motion.div
            className="bg-neugray-bg rounded-2xl shadow-neumorph p-3 sm:p-6 text-center"
          ...
          >
            ...
            <p className="text-2xl sm:text-4xl font-bold text-neugray-accent mt-1 sm:mt-2">
              {hiringOverview.openRequisitions}
            </p>
          </motion.div>
          <motion.div
            className="bg-neugray-bg rounded-2xl shadow-neumorph p-3 sm:p-6 text-center"
          ...
          >
            ...
            <p className="text-2xl sm:text-4xl font-bold text-neugray-accent mt-1 sm:mt-2">
              {hiringOverview.filledPositions}
            </p>
          </motion.div>
          <motion.div
            className="bg-neugray-bg rounded-2xl shadow-neumorph p-3 sm:p-6 text-center"
          ...
          >
            ...
            <p className="text-2xl sm:text-4xl font-bold text-neugray-accent mt-1 sm:mt-2">
              {hiringOverview.budgetUtilization}
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
          ...
          <div className="bg-neugray-bg rounded-2xl shadow-neumorph p-3 sm:p-6">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-3 sm:mb-4">
              <h2 className="text-lg sm:text-xl font-bold text-neugray-text mb-2 sm:mb-0">
                Team Requests
              </h2>
              <button
                onClick={() => {
              ...
              <table className="w-full min-w-full">
                <thead>
                  <tr className="text-left text-gray-500 text-sm">
                    ...
                    <th className="pb-2 sm:pb-3 px-2 hidden sm:table-cell">
                      Position
                    </th>
                    <th className="pb-2 sm:pb-3 px-2">Priority</th>
                    <th className="pb-2 sm:pb-3 px-2 hidden md:table-cell">
                      Status
                    </th>
          ...
          {/* Department Metrics */}
          <motion.div
            className="bg-neugray-bg rounded-2xl shadow-neumorph p-3 sm:p-6"
            variants={containerVariants}
            initial="hidden"
            animate="show"
          >
            <h2 className="text-lg sm:text-xl font-bold text-neugray-text mb-3 sm:mb-4">
              Department Metrics
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              {departmentMetrics.map((dept, index) => (
                <motion.div
                  key={index}
                  className="p-3 sm:p-4 bg-neugray-bg rounded-xl shadow-neumorph-sm"
                  variants={boxVariants}
                  initial="hidden"
                  animate="show"
                >
                  <h3 className="font-semibold text-neugray-text text-center mb-2 sm:mb-3 text-sm sm:text-base">
                    {dept.department}
                  </h3>
            ...
            {upcomingInterviews.map((interview) => (
              ...
              >
                <div className="mb-3 sm:mb-4">
                  <h3 className="font-semibold text-neugray-text text-sm sm:text-base">
                    {interview.candidate}
                  </h3>
                ...
                <div className="mb-3 sm:mb-4">
                  ...
                  <div className="flex mt-1 space-x-1">
                    {interview.interviewers.map((interviewer, idx) => (
                      <div
                        key={idx}
                        className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-neugray-accent text-white flex items-center justify-center text-xs sm:text-sm font-medium"
                      >
